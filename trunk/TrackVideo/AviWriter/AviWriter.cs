/**
 * Source: http://www.adp-gmbh.ch/csharp/avi/write_avi.html
 * Auhtor: René Nyffenegger
 * License: Assumed public license.
 */
...
namespace ReneNyffenegger {
    ...
    public class AviWriter : IDisposable {
        ...
        unsafe private void SetOptions() {
            ...
            opts.lpFormat = IntPtr.Zero; //new IntPtr(0);   // RM 20090911 replace 0=>IntPtr.Zero
            opts.cbFormat = 0;
            opts.lpParms = IntPtr.Zero; //new IntPtr(0);    // RM 20090911 replace 0=>IntPtr.Zero
            opts.cbParms = 0;
